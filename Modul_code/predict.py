...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_img", default="data/images/00099987.jpg", help="path to test image")
    parser.add_argument("--model_path", default="models/model.pth", help="path to the saved model")
    parser.add_argument("--int2char_path", default="data/data/int2char.pkl", help="path to int2char")
